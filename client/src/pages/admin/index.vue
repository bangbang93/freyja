      ...
      <el-col :span="4" class="freyja-side-menu">
        <el-menu mode="vertical" theme="light" class="freyja-side-menu" :router="true">
          <el-submenu index="article">
            ...
            <el-menu-item index="articleCreate" :route="{name: 'article.create'}">新建文章</el-menu-item>
            <el-menu-item index="articleList" :route="{name: 'article.list'}">文章列表</el-menu-item>
          </el-submenu>
          <el-submenu index="page">
          <template slot="title">页面管理</template>
          <el-menu-item index="pageCreate" :route="{name: 'page.create'}">新建页面</el-menu-item>
          <el-menu-item index="pageList" :route="{name: 'page.list'}">页面列表</el-menu-item>
        </el-submenu>
